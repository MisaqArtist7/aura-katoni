    ...
    <main class="flex-1 p-8 overflow-y-auto">
        ...
        <div class="bg-white p-8 rounded-3xl shadow-lg hover-scale fade-in">
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-3xl font-bold text-gray-800">مدیریت کامنت ها</h1>
            </div>
            @if(session('success'))
            ...
            <div class="overflow-x-auto">
                <table class="w-full border-collapse text-gray-800">
                    ...
                    <tr class="bg-gray-50">
                        ...
                        <th class="p-3 text-right">کامنت</th>
                        <th class="p-3 text-right">پاسخ</th>
                        ...
                        <tr class="hover:bg-gray-50 transition duration-200">
                            ...
                            <td class="p-3 text-center relative group">
                                <span class="truncate w-40 inline-block"
                                      onmouseover="showTooltip(event, '{{ $comment->user_comment }}')"
                                      onmousemove="moveTooltip(event)"
                                      onmouseout="hideTooltip()">
                                    {{ \Illuminate\Support\Str::limit($comment->user_comment, 40, '...') }}
                                </span>
                            </td>
                            ...
                            <td class="p-3 text-center">
                                <form action="{{ route('comments.reply') }}" method="POST">
                                    ...
                                    <textarea name="answer" class="form-control" placeholder="پاسخ خود را بنویسید..." required></textarea>
                            ...
                            <td class="p-3 text-center">
                                <button
                                    type="submit"
                                    class="bg-green-500 text-white px-4 py-2 rounded-full hover:bg-grren-600 transition duration-300"
                                >
                                    <a href="{{ route('admin.comments.approved',$comment->id)  }}">تایید برای نمایش</a>
                                </button>
                                <form
