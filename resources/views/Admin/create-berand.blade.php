        ...
        <section class="max-w-4xl mx-auto glass-effect p-6 md:p-8 rounded-3xl shadow-2xl fade-in">
            ...
            @if(session('success'))
                <div class="flex items-center p-4 mb-6 text-sm text-green-800 border border-green-300 rounded-xl bg-green-50 shadow-sm" role="alert">
                    ...
                    <div>
                        <span class="font-bold">عملیات موفق: </span>
                        <span class="font-medium">{{ session('success') }}</span>
                    </div>
                </div>
            @endif

            <form action="{{ route('admin.brand.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                @csrf
                ...
                <div class="group">
                    ...
                    <input type="text" name="title" id="brandTitle" value="{{ old('title') }}"
                ...
                <div class="group">
                    ...
                    <input type="text" name="name" id="brandName" value="{{ old('name') }}"
                           class="w-full px-4 py-3 border-2 rounded-xl border-gray-200 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 input-focus transition-all duration-300"
                           placeholder="نام برند"
                           onchange="updatePreview()" required>
                    <p class="text-sm text-gray-500 mt-1">نام انگلیسی برای URL استفاده می‌شود (مثل: samsung)</p>
                    @error('name')
                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="group">
                    ...
                    <textarea name="description" id="brandDescription"
                ...
                <div class="group">
                    ...
                    <div class="upload-area border-2 border-dashed border-gray-300 rounded-xl p-8 text-center cursor-pointer"
                        ...
                        <div class="mb-4">
                            ...
                            <p class="text-gray-600 font-medium">تصویر برند را اینجا بکشید یا کلیک کنید</p>
                ...
                <!-- نمایش پیام‌های موفقیت و خطای عملیات (زیر فیلدها) -->
                <div class="messages-container mt-4">
                    @if(session('success'))
                        <div class="flex items-center p-4 text-sm text-green-800 border border-green-300 rounded-xl bg-green-50">
                            <i class="fas fa-check-circle text-green-500 text-xl ml-2"></i>
                            <span class="font-medium">{{ session('success') }}</span>
                        </div>
                    @endif
                    ...
                    @if(session('error'))
                        <div class="flex items-center p-4 text-sm text-red-800 border border-red-300 rounded-xl bg-red-50">
