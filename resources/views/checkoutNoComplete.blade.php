...
<body class="max-w-[1700px] mx-auto">
  ...
  <header>
      ...
      <div class="flex justify-between items-center gap-x-5 w-full md:w-auto">
        ...
        <div id="mobile-menu" class="z-20 fixed top-0 right-0 w-10/12 h-full bg-white shadow-lg transform translate-x-full transition-transform duration-300 ease-in-out">
          <div class="p-5 flex flex-col gap-y-3 justify-center items-center">
            <!-- logo -->
            <a href="/">
              <img src="./assets/image/logo.png" class="max-w-24 md:max-w-32 h-fit" alt="">
            </a>
            <!-- seacrh -->
            <div class="relative block">
              ...
              <a href="#">
                <img class="top-3 absolute left-3 size-4" src="./assets/image/icons/lineicons_search-1.svg" alt="">
              </a>
            </div>
          </div>
          ...
          <div class="bg-zinc-100 w-full h-16 px-2 py-4 flex justify-between items-center fixed bottom-0">
            ...
            <a href="tel:05144556677" class="text-primary-500 flex text-xs lg:text-base gap-x-1 items-start">
              051-44556677
              <img class="w-3 lg:w-5" src="./assets/image/icons/headphones.svg" alt="">
            </a>
          </div>
        </div>
        <!-- logo -->
        ...
        <div class="relative hidden md:block">
          ...
          <a href="#">
            <img class="top-2.5 absolute left-3 size-5" src="./assets/image/icons/lineicons_search-1.svg" alt="">
          </a>
        </div>
      </div>
    ...
    <div class="md:bg-zinc-50 py-6 px-6 lg:px-14 justify-between flex">
      ...
      <ul class="hidden md:flex gap-x-5 xl:gap-x-8">
        <div class="relative inline-block group">
          <a href="#" class="pt-3 flex gap-x-2 items-center group relative">
            <img class="mb-2 size-4" src="./assets/image/icons/category.svg" alt="">
            <li class="relative text-zinc-600 text-sm group-hover:text-primary-500 transition pb-2
          ...
          <div id="dropdown-menu" class="absolute z-10 right-0 mt-2 md:w-2xl lg:w-4xl xl:w-7xl h-fit bg-white p-5 shadow-lg rounded-3xl flex opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300">
            <ul class="w-1/4 rounded-2xl bg-white drop-shadow-custom flex flex-col gap-y-3 p-3">
              <li class="category-item group/cat flex items-center gap-x-1 text-sm rounded-lg px-4 py-3 text-gray-600 hover:text-primary-500 cursor-pointer active-category" data-category="cat1">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <li class="category-item group/cat flex items-center gap-x-1 text-sm rounded-lg px-4 py-3 text-gray-600 hover:text-primary-500 cursor-pointer" data-category="cat2">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <li class="category-item group/cat flex items-center gap-x-1 text-sm rounded-lg px-4 py-3 text-gray-700 hover:text-primary-500 cursor-pointer" data-category="cat3">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <li class="category-item group/cat flex items-center gap-x-1 text-sm rounded-lg px-4 py-3 text-gray-700 hover:text-primary-500 cursor-pointer" data-category="cat4">
              ...
              <li class="category-item group/cat flex items-center gap-x-1 text-sm rounded-lg px-4 py-3 text-gray-700 hover:text-primary-500 cursor-pointer" data-category="cat5">
              ...
              <li class="category-item group/cat flex items-center gap-x-1 text-sm rounded-lg px-4 py-3 text-gray-700 hover:text-primary-500 cursor-pointer" data-category="cat6">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <li class="category-item group/cat flex items-center gap-x-1 text-sm rounded-lg px-4 py-3 text-gray-700 hover:text-primary-500 cursor-pointer" data-category="cat7">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <li class="category-item group/cat flex items-center gap-x-1 text-sm rounded-lg px-4 py-3 text-gray-700 hover:text-primary-500 cursor-pointer" data-category="cat8">
            ...
            <div class="w-2/3 p-4 grid grid-cols-2 xl:grid-cols-3 gap-y-5 gap-x-10" id="subcategory-container">
              <div>
        ...
        <a href="#" class="pt-1 flex gap-x-2 items-center group relative">
          <img class="mb-2 size-4.5" src="./assets/image/icons/discount.svg" alt="">
          <li class="relative text-zinc-600 text-sm group-hover:text-primary-500 transition pb-2
            after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-full after:h-[2px]
            after:bg-primary-500 after:scale-x-0 after:origin-right after:transition-transform after:duration-300
            group-hover:after:scale-x-100">
        ...
        <a href="#" class="pt-1 flex gap-x-1 items-center group relative">
          <img class="mb-2 size-4.5" src="./assets/image/icons/award.svg" alt="">
          <li class="relative text-zinc-600 text-sm group-hover:text-primary-500 transition pb-2
            after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-full after:h-[2px]
            after:bg-primary-500 after:scale-x-0 after:origin-right after:transition-transform after:duration-300
            group-hover:after:scale-x-100">
      ...
      <div class="flex gap-x-5">
        ...
        <div class="absolute top-3 left-16 md:top-0 md:left-0 md:relative group cursor-pointer border-2 border-primary-500 hover:shadow-lg hover:bg-zinc-200 transition rounded-xl p-2.5">
          ...
          <div class="z-50 hidden group-hover:block absolute -left-16 sm:left-0 top-11 w-96 md:w-[400px] rounded-2xl border border-zinc-300 bg-white shadow-lg">
            ...
            <div class="flex items-center justify-between border-t border-gray-100 p-5">
              ...
              <a href="checkout.blade.php" class="w-28 py-3 text-sm bg-primary-400 hover:bg-primary-500 transition text-gray-100 rounded-xl text-center">
                <button type="button">
                  ثبت سفارش
                </button>
              </a>
        ...
        <!-- login / register -->
        <a href="#" data-modal="modal1" class="open-modal absolute md:static top-3.5 left-3 md:flex bg-gradient-to-bl from-primary-500 to-primary-400 hover:opacity-90 hover:shadow-lg transition rounded-xl p-2.5 items-center gap-x-2 text-sm text-white">
    ...
    <!-- modal login -->
    <div id="modal1" class="modal fixed inset-0 bg-black/20 bg-opacity-50 hidden flex items-center justify-center transition-opacity duration-300 z-50">
      <div class="modal-box bg-white p-6 rounded-3xl shadow-lg w-10/12 md:w-6/12 lg:w-5/12 xl:w-3/12 opacity-0 scale-90 transition-transform duration-300">
        <!-- logo -->
        <img src="./assets/image/logo.png" class="max-w-32 h-fit mx-auto" alt="">
        <!-- login -->
        <div class="pt-5">
          ...
          <div class="relative mt-2">
            <input class="rounded-xl text-zinc-600 bg-[#f0f0f0] pl-10 pr-4 py-2.5 w-full placeholder:text-zinc-400 placeholder:text-sm focus:outline-0" type="tel" placeholder="09.........">
            <a href="#">
              <img class="top-3 absolute left-3 size-5" src="./assets/image/icons/phone.svg" alt="">
            </a>
          </div>
          <a href="#" class="text-center w-1/2 mx-auto mt-7 bg-gradient-to-bl from-primary-500 to-primary-400 hover:opacity-90 hover:shadow-lg transition rounded-2xl px-2.5 py-3 flex justify-center items-center gap-x-2 text-sm text-white">
            ارسال کد تایید
          </a>
        </div>
        <!-- verify -->
  ...
  <main class="mt-0 md:mt-8">
    <nav class="flex items-center gap-1 md:gap-5 w-full md:w-10/12 md:mx-auto">
      ...
      <a class="flex flex-col md:flex-row items-center w-fit min-w-24 md:min-w-32 gap-1 text-green-500 text-sm" href="cart.blade.php">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path class="fill-green-600" d="M16 6C16 7.06087 15.5786 8.07828 14.8284 8.82843C14.0783 9.57857 13.0609 10 12 10C10.9391 10 9.92172 9.57857 9.17157 8.82843C8.42143 8.07828 8 7.06087 8 6C8 4.93913 8.42143 3.92172 9.17157 3.17157C9.92172 2.42143 10.9391 2 12 2C13.0609 2 14.0783 2.42143 14.8284 3.17157C15.5786 3.92172 16 4.93913 16 6ZM15.678 13.503C15.205 13.508 14.764 13.526 14.38 13.577C13.737 13.664 13.033 13.87 12.452 14.452C11.87 15.033 11.664 15.737 11.578 16.38C11.5 16.958 11.5 17.664 11.5 18.414V18.586C11.5 19.336 11.5 20.042 11.578 20.62C11.638 21.071 11.758 21.552 12.025 22H12C4 22 4 19.985 4 17.5C4 15.015 7.582 13 12 13C13.326 13 14.577 13.181 15.678 13.503Z" fill="black"/>
          <path class="fill-green-600" fill-rule="evenodd" clip-rule="evenodd" d="M16.5 22C14.85 22 14.025 22 13.513 21.487C13 20.975 13 20.15 13 18.5C13 16.85 13 16.025 13.513 15.513C14.025 15 14.85 15 16.5 15C18.15 15 18.975 15 19.487 15.513C20 16.025 20 16.85 20 18.5C20 20.15 20 20.975 19.487 21.487C18.975 22 18.15 22 16.5 22ZM18.468 17.746C18.5774 17.6366 18.6389 17.4882 18.6389 17.3335C18.6389 17.1788 18.5774 17.0304 18.468 16.921C18.3586 16.8116 18.2102 16.7501 18.0555 16.7501C17.9008 16.7501 17.7524 16.8116 17.643 16.921L15.723 18.841L15.357 18.476C15.3028 18.4218 15.2385 18.3789 15.1677 18.3495C15.097 18.3202 15.0211 18.3051 14.9445 18.3051C14.8679 18.3051 14.792 18.3202 14.7213 18.3495C14.6505 18.3789 14.5862 18.4218 14.532 18.476C14.4778 18.5302 14.4349 18.5945 14.4055 18.6653C14.3762 18.736 14.3611 18.8119 14.3611 18.8885C14.3611 18.9651 14.3762 19.041 14.4055 19.1117C14.4349 19.1825 14.4778 19.2468 14.532 19.301L15.31 20.079C15.3641 20.1332 15.4284 20.1762 15.4992 20.2056C15.57 20.2349 15.6459 20.25 15.7225 20.25C15.7991 20.25 15.875 20.2349 15.9458 20.2056C16.0166 20.1762 16.0809 20.1332 16.135 20.079L18.468 17.746Z" fill="black"/>
        </svg>
        اطلاعات پرداخت
      </a>
      <div class="h-0.5 w-full bg-gradient-to-r from-white via-zinc-300 to-white"></div>
      <a class="flex flex-col md:flex-row items-center w-fit min-w-24 md:min-w-32 gap-1 text-primary-500 text-sm" href="cart.blade.php">
        <svg width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path class="stroke-primary-700" d="M20.5312 5.625H6.46875C4.60479 5.625 3.09375 7.13604 3.09375 9V18C3.09375 19.864 4.60479 21.375 6.46875 21.375H20.5312C22.3952 21.375 23.9062 19.864 23.9062 18V9C23.9062 7.13604 22.3952 5.625 20.5312 5.625Z" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
          <path class="stroke-primary-700" d="M3.09375 10.6875H23.9062" stroke="black" stroke-width="1.5"/>
          <path class="stroke-primary-700" d="M16.5938 16.0312H19.9688" stroke="black" stroke-width="1.5" stroke-linecap="round"/>
        </svg>
        اتمام خرید
      </a>
    </nav>
    <div class="mt-10 pb-20">
      <div class="bg-zinc-100 text-primary-500 text-base md:text-xl py-5 text-center leading-8 ">
        مشکلی در پرداخت بوجود آمده
        <br>
        مجدد پرداخت کنید یا با پشتیبانی تماس بگیرید
      </div>
      <div class="bg-zinc-100 grid grid-cols-2 gap-y-7 md:grid-cols-4 justify-items-center px-4 md:px-20 py-5 mt-8">
        <div class="flex flex-col justify-start gap-1">
          <div class="text-xs text-zinc-800 font-yekanBakhRegular">
            شماره سفارش:
          </div>
          <div class="text-sm text-zinc-800 font-yekanBakhBold">
            4587425
          </div>
        </div>
        <div class="flex flex-col justify-start gap-1">
  ...
  <footer class="bg-white border-t border-zinc-200 w-full px-5 md:px-10 py-5">
    ...
    <div class="flex gap-x-8 gap-y-4 items-center md:items-start flex-wrap md:flex-nowrap justify-between">
      <div class="w-4/12 md:w-1/12 order-1 md:order-none">
        <img class="w-full" src="./assets/image/logo.png" alt="">
      </div>
    ...
    <div class="flex flex-col md:flex-row gap-y-8">
      ...
      <div class="md:w-4/12 flex justify-center gap-x-7">
        <img class="h-fit max-w-20 md:max-w-28" src="./assets/image/service/symbol-02.png" alt="">
        <img class="h-fit max-w-20 md:max-w-28" src="./assets/image/service/zarinPal.png" alt="">
      </div>
      <div class="md:w-4/12">
